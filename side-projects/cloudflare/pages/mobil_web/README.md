...
1. `public` icerigini buraya tasiyin veya CI ile sync edin.
2. Pages project root olarak bu klasoru secin.
3. `_redirects` ve `_headers` dosyalarini gereksinime gore ekleyin.
