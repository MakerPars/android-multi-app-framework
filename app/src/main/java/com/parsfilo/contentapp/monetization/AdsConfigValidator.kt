...
@Singleton
class AdsConfigValidator @Inject constructor() {
    fun validateOrThrow(
        context: Context,
        useTestAds: Boolean,
    ) {
        ...
        AppAdUnitIds.resolvePlacement(context, AdPlacement.REWARDED_INTERSTITIAL_HISTORY_UNLOCK, useTestAds)
    }
    ...
    internal fun validateResolvedIds(
        ...
        require(ids.rewardedInterstitial.isNotBlank()) { "Missing rewarded interstitial ad unit id" }
